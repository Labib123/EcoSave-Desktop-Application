...
public class AdminShowUpdateMaterialDialog extends JDialog {
	...
	private AdminSearchMaterialByNameDialog searchDialog;
	private User myUser;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminShowUpdateMaterialDialog dialog = new AdminShowUpdateMaterialDialog(new JDialog());
	 ...
	 * Create the frame.
	 */
	public AdminShowUpdateMaterialDialog(JDialog parent) {
		super(parent, true);
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 459, 389);
		setTitle("EcoSave");
		adminUpdateMaterialDialog = new AdminUpdateMaterialDialog(this);
		searchDialog = new AdminSearchMaterialByNameDialog(this);
		...
		JLabel lblNewLabel = new JLabel("Show and Update Materials");
