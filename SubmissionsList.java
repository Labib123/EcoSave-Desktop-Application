...
public class SubmissionsList extends JDialog  implements Serializable{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SubmissionsList dialog = new SubmissionsList(new JFrame());
	 ...
	 * Create the frame.
	 */
	public SubmissionsList(final JFrame parent) {
		super(parent, true);
