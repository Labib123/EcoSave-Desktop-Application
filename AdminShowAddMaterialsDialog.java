...
public class AdminShowAddMaterialsDialog extends JDialog {
	...
	private AdminAddMaterialDialog adminAddMaterialDialog;
	 ...
	 * Create the frame.
	 */
	public AdminShowAddMaterialsDialog(JDialog parent) {
		super(parent, true);
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 450, 300);
		setTitle("EcoSave");
		adminAddMaterialDialog = new AdminAddMaterialDialog(this);
		...
		JButton btnAddMaterial = new JButton("Add A Material");
		btnAddMaterial.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				initShowMaterialsDisplay();
				adminAddMaterialDialog.pack();
				adminAddMaterialDialog.setVisible(true);
		...
		JLabel lblNewLabel = new JLabel("Show and Add Materials");
